 ...
 */
  peer.on('ready', () => {
    // handle ready event
    logger({ level: 'info', selection: 'log' })('UPNP server listening on port 1900.');
  ...
  peer.on('notify', (headers, address) => {
    // handle notify event
<<<<<<< HEAD
    logger({ level: 'info', selection: 'log' })('NOTIFY:', headers, address);
=======
<<<<<<< HEAD
    logger({ level: 'info', selection: 'log' })('NOTIFY:', headers, address);
=======
    console.log('NOTIFY:', headers);
>>>>>>> 720b324eb813e3c4d90ac8c4fe59336c63c89c90
>>>>>>> b928d3a3d4b6d6702460030e47492dd7305615e1
  });
...
<<<<<<< HEAD
>>>>>>> b928d3a3d4b6d6702460030e47492dd7305615e1
    logger({ level: 'info', selection: 'log' })('SEARCH:', headers, address);
...
>>>>>>> b928d3a3d4b6d6702460030e47492dd7305615e1
  ...
  peer.on('found', (headers, address) => {
    // handle found event
<<<<<<< HEAD
    logger({ level: 'info', selection: 'log' })('FOUND:', headers, address);
=======
<<<<<<< HEAD
    logger({ level: 'info', selection: 'log' })('FOUND:', headers, address);
=======
...
>>>>>>> b928d3a3d4b6d6702460030e47492dd7305615e1
  ...
  peer.on('close', () => {
    // handle close event
<<<<<<< HEAD
    logger({ level: 'info', selection: 'log' })('CLOSING.');
=======
<<<<<<< HEAD
    logger({ level: 'info', selection: 'log' })('CLOSING.');
=======
